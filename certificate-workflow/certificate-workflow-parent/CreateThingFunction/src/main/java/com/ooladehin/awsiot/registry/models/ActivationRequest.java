...
public class ActivationRequest {
	...
	public ActivationRequest(String certificateId, String caCertificateId, Long timestamp, String certificateStatus,
			String awsAccountId, String certificateRegistrationTimestamp, String pemFile, Date validThroughDate,
			Date validFromDate, String certificateArn, String serialNumber) {
		super();
